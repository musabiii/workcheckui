...
public class NotificationService
{
    ...
    public (bool choseBreak, string description, bool? modeSelected) ShowBreakOverlay(NotificationType type, string title, string message,
        ...
        SoundService? soundService = null, bool playSoundOnBreakEnd = false, bool fromWorkMode = false)
    {
        try
        {
            var overlay = new BreakOverlayWindow(type, title, message, breakDuration, skipPrompt, showChoice, soundService, playSoundOnBreakEnd, fromWorkMode);
